...
import "./IERC20.sol";
import "./SafeMathERC20.sol";

contract ERC20 is IERC20, SafeMathERC20 {
    ...
    function mint(address _account, uint256 _tokens) public virtual {
    ...
    function burn(address _account, uint256 _tokens) public virtual {
